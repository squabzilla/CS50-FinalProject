...
def get_lvl1_features_fighter():
    ...
    features_list.append(f'<select class="form-select" class="form-control w-auto" name="FeaturesSelect" id="FeaturesSelect" multiple aria-label="Multiple select example">\n')
